      ...
      <section className="py-12 sm:py-16 md:py-20 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-5 lg:gap-6 max-w-6xl mx-auto">
            {/* Concept testing */}
            <Card
              className="overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl hover:-translate-y-1 animate-fade-in p-3 sm:p-5 md:p-6 bg-white min-h-[130px] sm:min-h-[170px] border border-gray-200"
              style={{ animationDelay: '100ms' }}
            >
              {/* Pink icon background */}
              <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-lg bg-pink-100 flex items-center justify-center mb-2 sm:mb-4">
              ...
              <h3 className="text-sm sm:text-xl lg:text-2xl font-semibold text-foreground mb-1 sm:mb-2 leading-snug">Concept testing</h3>
            ...
            >
              ...
              <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-lg bg-teal-100 flex items-center justify-center mb-2 sm:mb-4">
              ...
              <h3 className="text-sm sm:text-xl lg:text-2xl font-semibold text-foreground mb-1 sm:mb-2 leading-snug"> Product Test</h3>
              <p className="text-muted-foreground text-xs sm:text-base md:text-lg leading-relaxed">
            ...
            >
              ...
              <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-lg bg-cyan-100 flex items-center justify-center mb-2 sm:mb-4">
                <svg className="h-5 w-5 sm:h-6 sm:w-6 text-cyan-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                </svg>
              </div>
              <h3 className="text-sm sm:text-xl lg:text-2xl font-semibold text-foreground mb-1 sm:mb-2 leading-snug">Foundational Research</h3>
              <p className="text-muted-foreground text-xs sm:text-base md:text-lg leading-relaxed">
            ...
            >
              ...
              <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-lg bg-rose-100 flex items-center justify-center mb-2 sm:mb-4">
              ...
              <h3 className="text-sm sm:text-xl lg:text-2xl font-semibold text-foreground mb-1 sm:mb-2 leading-snug">Brand Perception</h3>
              <p className="text-muted-foreground text-xs sm:text-base md:text-lg leading-relaxed">
            ...
            >
              ...
              <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-lg bg-orange-100 flex items-center justify-center mb-2 sm:mb-4">
              ...
              <h3 className="text-sm sm:text-xl lg:text-2xl font-semibold text-foreground mb-1 sm:mb-2 leading-snug">Creative Testing</h3>
              <p className="text-muted-foreground text-xs sm:text-base md:text-lg leading-relaxed">
            ...
            >
              ...
              <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-lg bg-emerald-100 flex items-center justify-center mb-2 sm:mb-4">
              ...
              <h3 className="text-sm sm:text-xl lg:text-2xl font-semibold text-foreground mb-1 sm:mb-2 leading-snug">Usability Testing</h3>
              <p className="text-muted-foreground text-xs sm:text-base md:text-lg leading-relaxed">
