              ...
              <CardContent className="p-6">
                {!isSubmitted ? (
                  ...
                  <div className="flex flex-col items-center justify-center min-h-[300px] text-center">
                    ...
                    <h2 className="text-2xl font-bold mb-2">Your demo request has been submitted!</h2>
                    <p className="text-lg text-muted-foreground mb-4">Thank you for your interest. We'll contact you within 24 hours to book your personalized demo.</p>
                  </div>
                )}
              </CardContent>
            </Card>
