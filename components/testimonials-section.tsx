    ...
    <section className="py-12 sm:py-16 md:py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10 sm:mb-12 md:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight text-foreground px-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 lg:gap-12 max-w-7xl mx-auto">
          ...
          <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-[#050849] p-6 sm:p-8 md:p-10 min-h-[300px] sm:min-h-[350px] md:min-h-[400px] flex flex-col shadow-lg sm:shadow-xl">
            {/* Top pill/badge */}
            <div className="w-20 sm:w-24 md:w-28 h-6 sm:h-7 bg-white/20 rounded-full mb-4 sm:mb-6"></div>
