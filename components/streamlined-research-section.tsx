...
export function StreamlinedResearchSection() {
  return (
    <section className="relative py-10 sm:py-16 md:py-20 lg:py-24 overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-none mx-auto mb-8 sm:mb-16 md:mb-20 flex justify-center">
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6 md:gap-8 max-w-7xl w-full">
              {/* Quick Start Panel */}
              <div className="group bg-white/40 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 shadow-lg sm:shadow-xl border border-white/50 hover:shadow-xl sm:hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] hover:bg-white/50">
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl sm:rounded-2xl p-1 mb-3 sm:mb-6 w-fit">
                ...
                <div className="space-y-1.5 sm:space-y-3">
                  <Button className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white justify-start text-sm sm:text-base font-semibold py-3 sm:py-5 md:py-6 rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-[1.02]">
                    <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3" />
                    Create with AI
                  </Button>
                  <button className="w-full text-left p-2.5 sm:p-4 rounded-xl sm:rounded-2xl hover:bg-white/60 flex items-center text-slate-700 font-normal transition-all duration-300 hover:scale-[1.01]">
                    <div className="w-7 h-7 sm:w-10 sm:h-10 bg-slate-100 rounded-lg sm:rounded-xl flex items-center justify-center mr-2 sm:mr-3">
              ...
              {/* Participants Panel */}
              <div className="group bg-white/40 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 relative shadow-lg sm:shadow-xl border border-white/50 hover:shadow-xl sm:hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] hover:bg-white/50">
                <div className="absolute top-3 sm:top-6 right-3 sm:right-6 bg-gradient-to-r from-red-500 to-red-600 text-white text-[10px] sm:text-xs font-bold rounded-full w-7 h-7 sm:w-10 sm:h-10 flex items-center justify-center shadow-lg">
                  2k
                </div>
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl sm:rounded-2xl p-1 mb-3 sm:mb-6 md:mb-8 w-fit">
                ...
                <div className="grid grid-cols-6 gap-2 sm:gap-3 mb-3 sm:mb-6 md:mb-8">
                  {/* Enhanced participant avatars with better shadows */}
                  <div className="w-9 h-9 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br from-blue-400 to-blue-600 border-2 border-white/80 shadow-lg flex items-center justify-center hover:scale-110 transition-transform duration-300">
                    <span className="text-white font-bold text-[10px] sm:text-xs md:text-sm">JD</span>
                  </div>
                  <div className="w-9 h-9 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br from-pink-400 to-pink-600 border-2 border-white/80 shadow-lg flex items-center justify-center hover:scale-110 transition-transform duration-300">
                    <span className="text-white font-bold text-[10px] sm:text-xs md:text-sm">SM</span>
                  </div>
                  <div className="w-9 h-9 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br from-green-400 to-green-600 border-2 border-white/80 shadow-lg flex items-center justify-center hover:scale-110 transition-transform duration-300">
                    <span className="text-white font-bold text-[10px] sm:text-xs md:text-sm">AR</span>
                  </div>
                  <div className="w-9 h-9 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br from-purple-400 to-purple-600 border-2 border-white/80 shadow-lg flex items-center justify-center hover:scale-110 transition-transform duration-300">
                    <span className="text-white font-bold text-[10px] sm:text-xs md:text-sm">KL</span>
                  </div>
                  <div className="w-9 h-9 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br from-orange-400 to-orange-600 border-2 border-white/80 shadow-lg flex items-center justify-center hover:scale-110 transition-transform duration-300">
                    <span className="text-white font-bold text-[10px] sm:text-xs md:text-sm">TW</span>
                  </div>
                  <div className="w-9 h-9 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br from-teal-400 to-teal-600 border-2 border-white/80 shadow-lg flex items-center justify-center hover:scale-110 transition-transform duration-300">
                    <span className="text-white font-bold text-[10px] sm:text-xs md:text-sm">MJ</span>
                  </div>
                </div>
                <Button className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white text-sm sm:text-base font-semibold py-3 sm:py-5 md:py-6 rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-[1.02]">
                  Add participants
                </Button>
              </div>

              {/* Results Panel */}
              <div className="group bg-white/40 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 shadow-lg sm:shadow-xl border border-white/50 hover:shadow-xl sm:hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] hover:bg-white/50 col-span-2 sm:col-span-2 lg:col-span-1">
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl sm:rounded-2xl p-1 mb-3 sm:mb-6 md:mb-8 w-fit">
                  <div className="bg-white rounded-lg sm:rounded-xl px-3 sm:px-4 py-1.5 sm:py-2">
                    <h3 className="text-sm sm:text-base md:text-lg font-semibold text-slate-800">Results</h3>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-2.5 sm:mb-4 md:mb-6">
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-3 sm:mb-6 md:mb-8">
                  <div className="bg-gradient-to-br from-amber-50 to-yellow-50 border border-amber-200/50 rounded-xl sm:rounded-2xl p-3 sm:p-4 text-center hover:scale-105 transition-transform duration-300">
        ...
        {/* Three Steps */}
        <div className="grid grid-cols-3 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-10 md:gap-12 lg:gap-16 max-w-7xl mx-auto">
          ...
          <div className="group text-left hover:scale-[1.02] transition-all duration-500 col-span-1 md:col-span-2 lg:col-span-1">
            <div className="flex items-center mb-4 sm:mb-6">
              <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg mr-3 sm:mr-4">
